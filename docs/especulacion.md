...
Para estudiantes y docentes de educación superior
Que quieren compartir y acceder a recursos educativos.
La biblioteca digital es una plataforma académica
Que permite acceder a contenido y crear material propio
A diferencia de las bibliotecas físicas tradicionales
Nuestro producto permite gestionar colecciones de contenido
personalizadas y compartirlas con la comunidad académica.

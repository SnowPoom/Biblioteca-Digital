...
urlpatterns = [
    ...
    path('materiales/<int:pk>/retirar/', views.retirar_libro, name='retirar_libro'),
    ...
    path('colecciones/<int:coleccion_id>/proponer_inclusion/', views.proponer_inclusion_coleccion, name='proponer_inclusion_coleccion'),
    path('colecciones/<int:coleccion_id>/proponer_exclusion/<int:libro_id>/', views.proponer_exclusion_coleccion, name='proponer_exclusion_coleccion'),
    path('colecciones/propuestas/<int:propuesta_id>/procesar/<str:accion>/', views.procesar_propuesta, name='procesar_propuesta'),
